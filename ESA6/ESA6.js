var app = ( function() {
	...
	function initModels() {
		...
		createModel("torus", fs, [0.5, 0, 0.3], [1.5, 0, 0], [1, 1, 1]);
		createModel("plane", "wireframe",  [0, -.8, 0], [0, 0, 0], [1, 1, 1]);
		createModel("planet", fs, [0.2, -.3, -0.2], [0, 0, 0], [.5, .5, .5]);
		createModel("planet", fs, [-1, -.3, -0.2], [0, 0, 0], [.5, .5, .5]);
		createModel("planet", fs, [0.2, -.3, 1], [0, 0, 0], [.5, .5, .5]);
		createModel("planet", fs, [-1, -.3, 1], [0, 0, 0], [.5, .5, .5]);

		// Select one model that can be manipulated interactively by user.
		interactiveModel = models[2];
