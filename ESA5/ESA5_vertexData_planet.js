...
var planet = (function () {
	...
	function createVertexData() {
		...
		function addIndicesTris(triangle, lines, dataset) {
			// Add index data.
			triangle.push(dataset.v1);
			triangle.push(dataset.v2);
			triangle.push(dataset.v3);
			lines.push(dataset.v1);
			lines.push(dataset.v2);
			lines.push(dataset.v2);
			lines.push(dataset.v3);
			lines.push(dataset.v3);
			lines.push(dataset.v1);
		}
